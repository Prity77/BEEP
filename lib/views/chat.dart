      ...
      appBar: AppBar(
        title: Text(
          ...
          style: GoogleFonts.kanit(
              textStyle: TextStyle(
                  color: Color(0xff243E36), fontWeight: FontWeight.bold)),
        ),
        elevation: 0.0,
        centerTitle: false,
      ),
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: widget.sendByMe
                  ? [const Color(0xff95BB93), const Color(0xff02182B)]
                  : [const Color(0xff95BB93), const Color(0xff02182B)],
            )),
        child: Column(
          children: [
            ...
            if (widget.sendByMe == false)
              ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(primary: Color(0xff243E36)),
